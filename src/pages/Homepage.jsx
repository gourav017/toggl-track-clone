...
function Homepage() {
  ...
  return (
    <div>
        ...
        <div
          style={
            screen > 800
              ...
              : { display: "grid", gridTemplateColumns: "1fr", padding: "2rem" }
          }
        >
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <div style={{ marginBottom: "4rem" }}>
              ...
              >
                <div>
                  Stand-up meeting 0:01:22 3D illustration TODO“I love the ease
                  of just clocking in and out with{" "}
      ...
      >
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            ...
            <em style={{ color: "hotpink" }}>time and money</em> , no matter how
            you use it.
          </h1>
        </div>
        <div
        ...
        >
          <div style={{ padding: "3rem", backgroundColor: "#fae5f6" }}>
            <h2
              style={{ fontSize: "1rem", color: "hotpink", fontWeight: "bold" }}
            >
        ...
        >
          ...
          >
            ...
            >
              ...
              <p style={{ marginBottom: "2rem" }}>
                Creative studio RogueMark Studios boosted resource allocation by
                45% thanks to accurate labor forecasting.
              </p>
              <p style={{ color: "hotpink" }}>Read case study</p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <div>
              ...
              <p>
                ...
                being productive is different for everyone. This is why Toggl
                Track is built into any workflow.
              </p>
            </div>
          </div>
          <div>
      ...
      <div style={{ color: "snow", padding: "3rem" }}>
        <div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
          ...
          >
            ...
            <p style={{ marginBottom: "2rem" }}>
              Request a 30-minute personalized demo to see how Toggl Track can
              meet your time tracking goals
            </p>
            <button
              style={{
                padding: "0.75rem 1.5rem",
